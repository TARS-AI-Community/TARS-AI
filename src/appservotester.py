...
----------------------
Find the lines below (around line 20) and change the values:

    WINDOW_WIDTH = 800   # Change to your desired width
    WINDOW_HEIGHT = 480  # Change to your desired height

Everything will automatically resize!

Examples:
- Touchscreen: 800x480 (default)
- Tablet: 1024x768
- HD Display: 1280x720
- Full HD: 1920x1080

The GUI uses a responsive design system that scales all elements proportionally.
"""
