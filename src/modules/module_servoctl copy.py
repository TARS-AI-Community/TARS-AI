...
def move_arm(left_main=None, left_forearm=None, left_hand=None,
    ...
    movements = [
        (left_main, leftMainMin, leftMainMax, 3),
        (left_forearm, leftForarmMin, leftForarmMax, 4),
        (left_hand, leftHandMin, leftHandMax, 5),
        (right_main, rightMainMin, rightMainMax, 6),
        (right_forearm, rightForarmMin, rightForarmMax, 7),
        (right_hand, rightHandMin, rightHandMax, 8),
    ]
